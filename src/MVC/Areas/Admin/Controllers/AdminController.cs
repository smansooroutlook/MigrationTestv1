    ...
    public class AdminController : Controller
    {
        ...
        static AdminController()
        {
            Mapper.CreateMap<Member, MemberModel>()
                .ForMember(dest => dest.LastOrderDate, opt => opt.MapFrom(src => src.LastOrderDate.ToString()));
            Mapper.CreateMap<MemberModel, Member>();
            Mapper.CreateMap<Order, OrderModel>()
                .ForMember(dest => dest.OrderDate, opt => opt.MapFrom(src => src.OrderDate.ToString()))
                .ForMember(dest => dest.RequiredDate, opt => opt.MapFrom(src => src.RequiredDate.ToString()))
